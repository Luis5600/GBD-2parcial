...
begin
        ...
        if(stock<=0) then
            raise exception 'Este producto no tiene stock, por tanto no se puede añadir a factura_mantenimiento';
        end if;
        return new;
end;
$tg_crear_product_line$
...
on factura_mantenimiento for each row
...
insert into producto (id_producto, id_clasificacion_producto,
					  ...
					  values (13, 1, 'Nueva exportación reciente', 'Teclado razer', 50, 0);
*/
/*
insert into mantenimiento (id_fvl, id_factura_venta, id_producto) values (48, 7, 13);
*/